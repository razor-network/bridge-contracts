...
const main = async () => {
  ...
  if (gasCost && gasCost > 0) {
    ...
    const costOnEthereum = Math.floor(((ethPrice * ethGasPrice * gasCost) / 1e9) * 100) / 100;
    ...
    const costOnMatic = Math.floor(((maticPrice * maticGasPrice * gasCost) / 1e9) * 100) / 100;
